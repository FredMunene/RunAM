...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full h-[129px] bg-[#73685D] z-50">
      <div className="absolute top-[32px] left-[25px] right-[25px] h-16 bg-white/10 backdrop-blur-sm border border-white/30 rounded-[10px]">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="absolute top-24 left-6 right-6 bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg p-4 md:hidden">
